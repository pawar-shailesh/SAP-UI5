		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comyashassignment4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyashassignment4-display": {
								"semanticObject": "comyashassignment4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yash.assignment4",
									"url": sap.ui.require.toUrl("com/yash/assignment4")
								}
							}
						}
					}
